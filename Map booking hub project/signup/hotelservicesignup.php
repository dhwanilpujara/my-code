...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO hotprov (username, fullname, password, email, phonenumber, dob, addresslines, country, city, post_code, merchantid, iifscode, accnumber) VALUES ('$username', '$fullname', '$password', '$email', '$phonenumber', '$dob', '$addresslines', '$country', '$city', '$post_code', '$merchantid', '$iifscode', '$accnumber')";
