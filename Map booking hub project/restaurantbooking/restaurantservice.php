...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $hotel_name = $_POST['restaurant_name'];
    ...
    $sql = "INSERT INTO restaurant (restaurant_name, no_table, chair, food_style, address_line_1, address_line_2, address_line_3, district, pincode, country, latitude, longitude, priceperson, mobilenumber) VALUES ('$restaurant_name', '$no_table', '$chair', '$food_style', '$address_line_1', '$address_line_2', '$address_line_3', '$district', '$pincode', '$country', '$latitude', '$longitude', '$priceperson', '$mobilenumber')";
        ...
        <form method="POST">
            <div class="step step-1 active">
                <div class="form-group">
                    ...
                    <input type="text" id="hotel_name" name="restaurant_name" />
                </div>
                <div class="form-group">
                    <label for="floor">Table:</label>
                    <input type="number" id="floor" name="no_table" />
                </div>
                <div class="form-group">
                    <label for="room">Chair:</label>
                    <input type="number" id="room" name="chair" />
                </div>
                <div class="form-group">
                <label for="washroom">Food Style:</label>
                <select id="washroom" name="food_style">
            ...
            <div class="step step-3">
                <div class="form-group">
                    ...
                    <input type="number" id="phone" name="mobilenumber" />
                </div>
                <div class="form-group">
                    <label>Price per person:</label>
                    <input type="number" step="0.01" name="priceperson" id="price_2_bed"/>
                    <button type="button" onclick="adjustPrice('price_2_bed', 0.01)">+</button>
                    <button type="button" onclick="adjustPrice('price_2_bed', -0.01)">-</button><br>
                </div>
                <div class="form-group">
            ...
            <div class="step step-4">
                <button type="submit" class="submit-btn">Restaurant Deployed</button>
            </div>
        </form>
    </div>
</section>
